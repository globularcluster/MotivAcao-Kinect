...
public class SpeechWrapper 
{
	...
	[DllImport("KinectUnityWrapper")]
	public static extern int LoadSpeechGrammar([MarshalAs(UnmanagedType.LPWStr)]string sFileName, short iNewLangCode, bool bDynamic);
	[DllImport("KinectUnityWrapper")]
	public static extern int AddGrammarPhrase([MarshalAs(UnmanagedType.LPWStr)]string sFromRule, [MarshalAs(UnmanagedType.LPWStr)]string sToRule, [MarshalAs(UnmanagedType.LPWStr)]string sPhrase, bool bClearRule, bool bCommitGrammar);
	[DllImport("KinectUnityWrapper")]
	...
	[DllImport("KinectUnityWrapper")]
	public static extern float GetPhraseConfidence();
	[DllImport("KinectUnityWrapper")]
