...
public class WrapperTools
{
	...
	public static bool EnsureKinectWrapperPresence()
	{
		...
		if(!Is64bitArchitecture())
		{
			...
			CopyResourceFile(sTargetPath + "msvcp100.dll", "msvcp100.dll", ref bOneCopied, ref bAllCopied);
			CopyResourceFile(sTargetPath + "msvcr100.dll", "msvcr100.dll", ref bOneCopied, ref bAllCopied);
		}
		else
		{
			...
			CopyResourceFile(sTargetPath + "msvcp100.dll", "msvcp100.dll.x64", ref bOneCopied, ref bAllCopied);
			CopyResourceFile(sTargetPath + "msvcr100.dll", "msvcr100.dll.x64", ref bOneCopied, ref bAllCopied);
		}
